...
- ![page2](./img/page2.png)페이지2 글을 작성하는 페이지입니다 사진과 제목그리고 본문을 입력해서 글쓰기를 해보세요
- ![page3](./img/page3.png)페이지3 현재 내위치를 통해서 작성한 글쓰기들이 동그라미로 나타납니다
- ![page4](./img/page4.png)페이지4 폰트와테마를 변경할수있습니다
